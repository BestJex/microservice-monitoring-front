        ...
        <Form layout='online' {...formlayout}>
          <Row>
            <Col span={18}>
              <Row>
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.activityTypeCode`).d('邮件编码')} {...formlayout}>
                ...
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.statusCode`).d('邮件标题')} {...formlayout}>
                ...
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.activityId`).d('发件人')} {...formlayout}>
              ...
              <Row style={{ display: display ? 'none' : 'block' }}>
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.activityName`).d('收件人')} {...formlayout}>
                ...
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.activityChannelCode`).d('邮件状态')} {...formlayout}>
