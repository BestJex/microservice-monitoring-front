        ...
        <Form>
          <Row>
            <Col span={18}>
              <Row>
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.warningTitle`).d('预警标题')} {...formlayout}>
                ...
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.warningSender`).d('发件人')} {...formlayout}>
                ...
                <Col span={8}>
                  <Form.Item label={intl.get(`${preCode}.warningRecipient`).d('收件人')} {...formlayout}>
